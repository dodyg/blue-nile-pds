...
public class EmailTokenStore
{
    ...
    {
        var encoded = Utils.RandomBase32String(8);
        var token = $"{encoded[..5]}-{encoded[5..10]}";
    ...
    public async Task AssertValidTokenAsync(string did, string token, EmailToken.EmailTokenPurpose purpose)
    {
