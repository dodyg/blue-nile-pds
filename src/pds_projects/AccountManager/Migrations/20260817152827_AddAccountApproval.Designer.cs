...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountManager.Db.AppPassword", b =>
                {
                    b.Property<string>("Did")
                        .HasMaxLength(2048)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AccountManager.Db.AuthorizedClient", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(2048)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AccountManager.Db.Device", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(2048)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AccountManager.Db.UsedRefreshToken", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(2048)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AccountManager.Db.Account", b =>
                {
                    b.HasOne("AccountManager.Db.Actor", "Actor")
                        .WithOne("Account")
                        .HasForeignKey("AccountManager.Db.Account", "Did");
