...
namespace BlueNilePds.Pds.ActorStore.Migrations
{
    ...
    [Migration("20260112165417_BlobStatus")]
    partial class BlobStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueNilePds.Pds.ActorStore.Db.AccountPref", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BlueNilePds.Pds.ActorStore.Db.Backlink", b =>
                {
            ...
            modelBuilder.Entity("BlueNilePds.Pds.ActorStore.Db.Blob", b =>
                {
            ...
            modelBuilder.Entity("BlueNilePds.Pds.ActorStore.Db.Record", b =>
                {
                    b.Property<string>("Uri")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BlueNilePds.Pds.ActorStore.Db.RecordBlob", b =>
                {
            ...
            modelBuilder.Entity("BlueNilePds.Pds.ActorStore.Db.RepoBlock", b =>
                {
                    b.Property<string>("Cid")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BlueNilePds.Pds.ActorStore.Db.RepoRoot", b =>
                {
